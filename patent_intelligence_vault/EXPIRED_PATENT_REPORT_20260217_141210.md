...
**Report Generated:** 2026-02-17T14:12:10.312986  
**Dataset Size:** 186 patents  
**Report ID:** `20260217_141210`

---

## Executive Summary

This report presents a comprehensive analysis of 186 expired patents using a multi-dimensional framework combining technical robustness, manufacturing feasibility, financial attractiveness, and strategic alignment.

### Key Findings

- **Total Patents Analyzed:** 186
- **High-Potential Candidates (Tier 1):** 4 patents recommended for immediate implementation or pilot projects
- **Further Investigation Required (Tier 2):** 182 patents requiring additional R&D or FTO analysis
- **Average Integrated Score:** 6.00/10.0

### Investment Opportunity Summary

The analysis identifies significant economic opportunity through reviving expired technologies:

- **Top Tier 1 Patent:** Oil well pumpoff control system utilizing integration timer
  - Score: 6.97/10.0
  - NPV (Base): $186,318

- **Estimated Portfolio NPV:** $21,799,217
...
#### 1. **Oil well pumpoff control system utilizing integration timer**
...
#### 2. **Servo control positioning apparatus including a standing wave detector**
...
- **3932756:** X-ray detector for a panoramic X-ray device
  - Score: 6.67/10 | Action: Conduct detailed FTO analysis
...
|-------|-------|-----------|
| Control Systems | 21 | 5.92 |
| Energy | 4 | 5.89 |
| Apparatus | 27 | 6.07 |
| Materials | 19 | 5.80 |
| Enabling Technology | 43 | 5.71 |
| Sensors | 60 | 6.33 |
| Wireless | 3 | 5.76 |
| Process | 9 | 5.72 |
...
| Metric | Value |
|--------|-------|
| Total Portfolio NPV (Base) | $21,799,217 |
| Total Portfolio NPV (Optimistic) | $55,221,326 |
| Average Annual Cost Savings | $25,948 |
...
- **Full Results (JSON):** `patent_analysis_results_20260217_141210.json`
- **Rankings (CSV):** `patent_rankings_20260217_141210.csv`
...
**Report Version:** 1.0  
**Last Updated:** 2026-02-17T14:12:10.313266  
